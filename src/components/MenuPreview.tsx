  ...
  return (
    <section className="menu-preview" id="menu-preview">
      ...
      <div className="menu-pdf-buttons">
        <Link href="/menu?tab=tea" className="menu-pdf-btn">{t("Чайная карта", "Tea Menu")}</Link>
        <div className="menu-pdf-divider" />
        <Link href="/menu?tab=hookah" className="menu-pdf-btn">{t("Кальянная карта", "Hookah Menu")}</Link>
      </div>
