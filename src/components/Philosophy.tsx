  ...
  return (
    <section className="philosophy" ref={sectionRef} id="about">
      ...
      <div className="phil-content">
        <div className="phil-opening phil-hidden" dangerouslySetInnerHTML={{ __html: t("Мы не ищем гостей —<br>мы открыты единомышленникам.", "We don't seek guests —<br>we welcome the like-minded.") }} />
